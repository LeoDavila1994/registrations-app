...
const createRegistrations = async (req, res) => {
    try {
        ...
        const newRegistration = await Registrations.create({ entranceTime, status });
...
module.exports = { getAllRegistrations, getRegistrationsById, createRegistrations, updateRegistration, deleteRegistration };