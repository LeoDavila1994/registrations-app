...
const { getAllRegistrations, getRegistrationsById, createRegistrations, updateRegistration, deleteRegistration } = require("../controllers/registrations.controller");

const registrationsRouter = express.Router();

const { registrationExist } = require("../middlewares/registrations.middleweares");
